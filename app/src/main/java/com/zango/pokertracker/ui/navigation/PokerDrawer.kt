...
enum class AppDestination(val route: String, val label: String, val icon: ImageVector) {
    GAME_HUB(Routes.HISTORY, "Game hub", Icons.Filled.Casino),
    PLAYERS(Routes.PLAYERS, "Players", Icons.Filled.Group),
...
fun PokerDrawerContent(
    ...
    ModalDrawerSheet(
        ...
        Column(
            ...
            Text("Poker Tracker", style = MaterialTheme.typography.titleLarge)
            Text(
                "The bank for your home game",
