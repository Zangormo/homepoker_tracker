...
data class Settlement(
    ...
    val hasUnsettledRemainder: Boolean get() = unsettled.isNotEmpty()

    val winners: List<PlayerNet> get() = nets.filter { it.net.isPositive }

    val losers: List<PlayerNet> get() = nets.filter { it.net.isNegative }
}
